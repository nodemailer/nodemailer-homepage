...
- [Message configuration](/message/) - where `alternatives` sits among the body fields.
- [Embedded images](/message/embedded-images) - inline images, which build a different MIME container.
- [Attachments](/message/attachments) - the content sources alternatives share with attachments.
- [Calendar events](/message/calendar-events) - an alternative part with its own handling.
- [Custom source](/message/custom-source) - bypass MIME building entirely.
